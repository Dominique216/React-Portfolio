        ...
        <div id="works" className="works-section">
           ...
           <div data-aos="fade-right" data-aos-offset="500" className='box1 sm:w-full md:w-4/5'>
                ...
                <div data-aos="fade-left" data-aos-offset="500" className='box2 ml-auto sm:w-full md:w-4/5 '>
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="ml-2">A FullStack blog site that requires signup or login. Once logged in, users can view existing posts and comments, add comments, and add, update, or delete their posts. This was made using Node, Express, MySql, Sequelize, Handlebars, and Bootstrap.</p>
                        <div className="d-inline m-auto">
           ...
           <div data-aos="fade-right" data-aos-offset="500" className='box3 sm:w-full md:w-4/5'>
                ...
                <div className="flex flex-col">
                    ...
                    <p className="ml-2">ProPairs is a FullStack MERN application that evaluates users based on their personality type and generates a rating of how well they will work together with one another based on their Myers-Briggs personality type. It was made using React, Material UI, mongoDB, mongoose, node, and express.</p>
                    <div className="d-inline m-auto">
